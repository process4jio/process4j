...
public class BPMNBusinessRuleTask extends BPMNActivity
{
   @XmlAttribute
   private String id;
   ...
   public BPMNBusinessRuleTask(String id, String name, BPMNOutgoing outgoing, BPMNIncoming... incoming)
   {
      this.id = id;
      this.name = name;
   ...
   @XmlTransient
   public BPMNBusinessRuleTask setName(String name)
   {
      this.name = name;
      return this;
   }
