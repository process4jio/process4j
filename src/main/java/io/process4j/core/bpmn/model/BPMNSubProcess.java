...
public class BPMNSubProcess extends BPMNActivity
{
   @XmlAttribute
   private String id;
   ...
   public BPMNSubProcess(String id, String name, BPMNOutgoing outgoing, BPMNIncoming... incoming)
   {
      this.id = id;
      this.name = name;
   ...
   @XmlTransient
   public BPMNSubProcess setName(String name)
   {
      this.name = name;
      return this;
   }
